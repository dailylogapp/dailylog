...
@RestController
@RequestMapping("/logs")
@CrossOrigin(origins = "http://localhost:3000") // Funciona igual en producción!
public class LogController {
    ...
    //Registros paginados (los 10 ultimos se muestran primero)
    @GetMapping("/paged")
    public Page<Log> getLogsPaged(
